    ...
    <>
      ...
      <div className='fixed inset-0 bg-black/40 z-40 flex items-center justify-center p-0 sm:p-4 backdrop-blur-sm'>
        ...
        >
          ...
          <button
            onClick={closeWindow}
            className='absolute top-4 right-4 font-[Poppins] cursor-pointer text-gray-500 hover:text-red-500 text-[15px] font-medium px-4 py-2 rounded-full bg-gray-50 hover:bg-gray-100 transition-colors mb-[15px]'
          >
            Close
          </button>
        </div>
